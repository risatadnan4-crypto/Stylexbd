    ...
    "seoSlug" TEXT
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="md:col-span-2 border border-white/10 bg-white/[0.03] p-6 rounded-xl space-y-5 shadow-[0_4px_24px_rgba(0,0,0,0.15)] transition-all duration-300 hover:border-white/20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      {/* 🎁 BUY & GET OFFER (বাই এন্ড গেট অফার) */}
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              <span className="text-[9.5px] text-purple-300/80 font-sans block">
                                অর্ডার সম্পন্ন হলে কাস্টমার পরবর্তী অর্ডারের জন্য ১-টাইম কুপন পাবেন
                              </span>
                            </div>
                          </div>
                          <div className="flex items-center gap-2">
                        ...
                        {formBuyAndGetEnabled && (
                          <div className="space-y-3 pt-1 animate-fade-in">
                            ...
                            <div className="bg-purple-950/50 border border-purple-500/30 rounded-lg p-2.5 text-[10.5px] text-purple-200 leading-relaxed font-sans flex items-start gap-2">
                              ...
                              <span>
                                কাস্টমার এই প্রোডাক্টটি কিনলে অর্ডারের সাথে সাথে তার পরবর্তী কেনাকাটার জন্য একটি <strong>{formBuyAndGetDiscountPercent}% ডিসকাউন্টের ইউনিক ওয়ান-টাইম (একবার ব্যবহারযোগ্য) কুপন কোড</strong> (যেমন: <code className="text-luxury-gold bg-black/40 px-1 py-0.5 rounded font-mono font-bold">BG8X2K9P</code>) তৈরি হবে যা কাস্টমার স্ক্রিন ও WhatsApp-এ পাবেন।
                              </span>
                            </div>
                          </div>
                        )}
                            ...
                            <div className="flex flex-wrap items-center gap-1.5 mt-1 font-mono text-[8.5px]">
                              ...
                              {p.buyAndGetOfferEnabled && (
                                <span className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 text-purple-300 font-extrabold px-1.5 py-0.5 rounded border border-purple-500/30 shadow-[0_0_8px_rgba(168,85,247,0.2)]">
                                  🎁 BUY & GET (-{p.buyAndGetDiscountPercent || 15}%)
                                </span>
                              )}
                            </div>
                          </div>
        ...
        {activeTab === 'sms' && (
          <div className="space-y-6 max-w-5xl animate-fade-in text-white">
            ...
            {/* QUICK SEND MANUAL SMS - CLEANED & VERIFIED */}
            <div className="border border-luxury-gold/20 bg-[#0d0d0d] p-6 rounded-lg shadow-xl relative overflow-hidden">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#141414] border border-white/10 x��Z͓�����ɖ\���`{ga�YfOj>����Z�nA+�_�VX�c�S�9�JU2N%�$�\���I݀�[��IU*L� ��Zz���~z��o����-N<�é1��֪�Џ=�X(0�bdI���m�
lF��h�5�h�{�p}�G~����=Rz��ڑ��]��e�#��Qt�]�)�֡�;F`�h�T ��qd�����.�ٯ�wҊ�  ��#�X��kꍌ1�HĒ�~�����jK�|�z=ԅ��c���FF5t
�4�+�E�Ī5;�ia�	�@��^3M'Bl�<|��S⯐�<�!��$,tJ��_.n�������_�����/�m��׋�߯�~#���|}��.>�n��W������4}�y��7�o�W�;1��\�����E4�k�^׆#��u�PD؅$W&U��aU1iE?�tcc;��o~���ޡľҷ�T���<��m79���W{3�{[p��n@�E#<p�ՙEĳ��V�I}�7��l�	���CGvj���5
